							...
							<div class="about" >
                               ...
                               <c:forEach items="${list}" var="dogType" varStatus="vs">
									...
									<li>
                                        ...
                                        <a href="javascript:void(0);">宠物名:${dogType.dogTypeName}</a>
                                        <p style="width:100%;">${dogType.dogIntroduce}</p>
                                        </h2>
                                    </li>
            ...
            $.ajax({
                  ...
                  success:function(data){
                      ...
                      for(var i=0;i<data.list.length;i++)
                        {  
                           $("#ulBody").append('<li><h2 id='+i+'> <a href=javascript:void(0);><img src=upload/'+data.list[i].dogTypeImg+' width=140 height=250/></a>'); 
                           $("#"+i).append('<a href=javascript:void(0);>标题:'+data.list[i].dogTypeName+'</a>');
                           $("#"+i).append('<p style=width:100%;>'+data.list[i].dogIntroduce+'</p></h2>');
