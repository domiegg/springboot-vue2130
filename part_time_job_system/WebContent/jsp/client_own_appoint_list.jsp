...
$(function(){
    ...
    function toLimitit(tag){
        $.ajax({
              type:"POST",
              url: "client/toClientOwnTargetAppointPage",
              ansyc:false,
              data:{Page:tag,
              },
              dataType:"json",
              ...
              success:function(data){
                  ...
                  {  
                     ...
                     $("#"+i).append('<td><a href=client/toAddClientAssment?appointId='+data.list[i].appointId+'><font color=blue>'+data.list[i].clientAssment +'</font></a></td>');
