			...
			<div class="twelve wide column">
                ...
                <div class="ui vertical segment" >
						<div  style="margin-left:10px;">
                            ...
                            <a class="ui small teal button" href="javascript:void(0);" id="bsel" title="+提加用户"><i class="cloud download icon"></i>查询操作</a>
                             
                             <div class="ui small icon input right">
                             <form action="bussiness/toModPage" id="modForm">
                              <input type="text" name="bussinessId" id="bussinessId" placeholder="请输入商家编号">
                             </form>
    ...
    $("#bsel").on('click',function(){
 		 ...
 		 $.ajax({
		       ...
		       success:function(data){
		    	...
		    	info=info+"联系地址:"+data.bussiness.bussinessAddress+"<br>";
    ...
    $("#del").on('click',function(){
		...
		layer.confirm('是否删除该条信息？', {
			  btn: ['是','否'] //按钮
				 ...
				 $.ajax({
				       type:"POST",
				       url: "bussiness/delBussinessById",
				       data:{bussinessId:bussinessId
				       },
				       dataType:"json",
				       contentType:"application/x-www-form-urlencoded;charset=utf-8",
