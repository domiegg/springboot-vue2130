...
<div class="ui teal inverted menu">
	<div class="bigcontainer">
		<div class="right menu">
            ...
            <a class="active item" href="jsp/bussiness_main.jsp"><i class="home icon"></i>首页</a>
            <a class="item" href="bussiness/toBussinessOwnAppointList"><i class="sitemap icon"></i>兼职信息管理</a>
            <a class="item" href="bussiness/toModPage?bussinessId=${account }"><i class="info icon"></i>个人信息设置</a>
	</div>
	</div>
</div>
...
$(function(){
    ...
    function toLimitit(tag){
        ...
        $.ajax({
              type:"POST",
              url: "bussiness/toBussinessOwnTargetAppointPage",
              ansyc:false,
              data:{Page:tag,
              },
              dataType:"json",
              ...
              success:function(data){
                  ...
                  {  
                     ...
                     $("#"+i).append('<td><a href=bussiness/toAddBussinessAssmen?appointId='+data.list[i].appointId+'><font color=blue>'+data.list[i].businessAssment +'</font></a></td>');
