                ...
                <div class="ui vertical segment" >
						<div  style="margin-left:10px;">
                            <a class="ui small teal button" href="javascript:void(0);" id="sel" title="+提加用户"><i class="cloud download icon"></i>查询操作</a>
                             <a class="ui small teal button" href="javascript:void(0);" id="getAp" title="+提加用户"><i class="cloud download icon"></i>接单</a>
    ...
    $(function(){
   	 $("#getAp").on('click',function(){
 		 $.ajax({
		       type:"POST",
		       ansyc:false,
		       url: "client/getAppoint",
		       data:{appointId:$("#appointId").val()
		       },
		       dataType:"json",
		       contentType:"application/x-www-form-urlencoded;charset=utf-8",
		       success:function(data){
		    	   var info="接单成功,请等待商家确认!!<br>";
		    	   layer.open({
		    		   type: 0,
		    		   shade: false,
		    		   title: false, //不显示标题
...
$(function(){
    ...
    function toLimitit(tag){
        $.ajax({
              type:"POST",
              url: "client/toClientTargetAppointPage",
              ansyc:false,
              data:{Page:tag,
              },
              dataType:"json",
